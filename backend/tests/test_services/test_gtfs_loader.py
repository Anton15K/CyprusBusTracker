...
from app.services.gtfs_loader import DatabaseReset, BaseOperations, GraphBuild, Updater
import os
...
def test_updater_download_files(mocker):
    ...
    updater = Updater("/tmp/src", "/tmp/target", "/tmp/osm", "otp.jar", ["http://test.com?file=gtfs.zip"])
